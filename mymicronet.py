...
print('Output')
L11o1 = tf.concat([L11fh5, L11sh3], 3)
...
print('Output')
L12o1 = tf.concat([L12fh5, L12sh3], 3)
...
##concatenate L12fh5 and L12sh3
#print('Output')
#L13o1 = tf.concat([L13fh5, L13sh3], 3)
...
L31fh1 = Deconvolution2D(256, kernel_size = (7,7), activation = "tanh",name = "ct_deconv_l31fh6")(L21o)
# (3,3) +2,+2
...
print('L31sh1 shape: ',L31sh1.shape)
L31sh2 = tf.concat([L31sh1, L31fh7], 3)
print('L32ot shape: ',L31sh2.shape)
L31o = Conv2D(256, kernel_size = (3,3), kernel_regularizer=regularizers.l2(weight_decay), activation = "tanh",padding="same")(L31sh2)
print('L32ot shape: ',L31o.shape)

#Second block
print('Second block')
print('Fhalf')
# L31fh1 = UpSampling2D( size = (2,2)) (L21o)
L32fh1 = Deconvolution2D(128, kernel_size = (7,7), activation = "tanh",name = "ct_deconv_l31fh6")(L11o1)
# (3,3) +2,+2
print('L31fh1 shape: ',L32fh1.shape)
L32fh2 = Conv2D(128,kernel_size=(3,3),kernel_regularizer=regularizers.l2(weight_decay))(L32fh1)
# (3,3) -2,-2
print('L31fh2 shape: ',L32fh2.shape)
L32fh3 = Activation('tanh')(L32fh2)
print('L31fh3 shape: ',L32fh3.shape)
L32fh4 = Conv2D(128,kernel_size=(3,3),kernel_regularizer=regularizers.l2(weight_decay))(L32fh3)
print('L31fh4 shape: ',L32fh4.shape)
L32fh5 = Activation('tanh')(L31fh4)
print('L13fh5 shape: ',L32fh5.shape)
L32fh6 = Deconvolution2D(128, kernel_size = (7,7), activation = "tanh",name = "ct_deconv_l31fh6")(L32fh5)
# L32fh6 = UpSampling2D( size = (2,2)) (L31fh5)
print('L31fh6 shape: ',L32fh6.shape)
L32fh7 = BatchNormalization()(L32fh6)
print('L31fh7 shape: ',L32fh7.shape)
...
print('\nGroup 5')
#only one block
L51sh1 = tf.concat([L41fo, L42fo], 3)
...
L51o = Conv2D(8, kernel_size = (1,1), kernel_regularizer=regularizers.l2(weight_decay), activation = "tanh")(L51sh4)
